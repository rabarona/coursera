...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        Point one = new Point(10, 100);
        Point two = new Point(20, 200);
        Point three = new Point(300, 3000);
        Point four = new Point(400, 4000);
    ...
    public double slopeTo(Point that) {
        ...
        // degenerate line
        if (this.x == that.x && this.y == that.y) return Double
                .NEGATIVE_INFINITY;
    ...
    private class PointOrder implements Comparator<Point> {
         ...
         * slope  (y2 − y0) / (x2 − x0). Treat horizontal, vertical, and
         ...
         *
         * @param point1 the first object to be compared.
         * @param point2 the second object to be compared.
